...
// // // //             // Duración mínima (6 meses desde inicio de contrato)
// // // //             if (aprendiz.fechaInicioContrato) {
// // // //                 const inicioContrato = new Date(aprendiz.fechaInicioContrato);
// // // //                 const diffMeses = (finContrato - inicioContrato) / (1000 * 60 * 60 * 24 * 30);
// // // //                 if (diffMeses < 6) {
// // // //                     newErrors.fechaFinContrato = 'El contrato debe tener una duración mínima de 6 meses';
// // // //                     isValid = false;
// // // //                 }
// // // //             }

// // // //             // Duración máxima (2 años desde inicio productiva)
// // // //             if (formData.fechaInicioProductiva) {
// // // //                 const inicioProductiva = new Date(formData.fechaInicioProductiva);
// // // //                 const diffMeses = (finContrato - inicioProductiva) / (1000 * 60 * 60 * 24 * 30);
// // // //                 if (diffMeses > 24) {
// // // //                     newErrors.fechaFinContrato = 'La etapa productiva no puede durar más de 2 años';
// // // //                     isValid = false;
// // // //                 }
// // // //             }

// // // //             // Si está en productiva, fin debe ser futuro
...
// // // //             ? new Date(new Date(aprendiz.fechaInicioContrato).getTime() + (180 * 86400000)).toISOString().split('T')[0]
// // // //             : undefined;

// // // //     const maxFechaFinContrato = formData.fechaInicioProductiva
// // // //         ? new Date(new Date(formData.fechaInicioProductiva).getTime() + (730 * 86400000)).toISOString().split('T')[0]
// // // //         : undefined;
