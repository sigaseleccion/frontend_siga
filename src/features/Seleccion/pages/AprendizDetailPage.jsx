...
export default function AprendizDetailPage() {
  ...
  const [pruebas, setPruebas] = useState({ psicologica: 'pendiente', medica: 'pendiente' })
    ...
    <div>
      ...
      <main className="ml-72 min-h-screen bg-gray-50 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-2">Progreso y estado de pruebas</p>
        </div>
        ...
        <div className="grid gap-6 lg:grid-cols-2 mt-6">
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-sm font-medium text-muted-foreground">Fecha Inicio Contrato</p>
                <p className="text-sm">{fechaInicioContrato || '-'}</p>
              </div>
              <div>
                <p className="text-sm font-medium text-muted-foreground">Fecha Fin Contrato</p>
                ...
                <div className="space-y-6">
                  <div className="relative flex items-start gap-4 pl-10">
                    ...
                    <div className="flex-1 space-y-3 min-w-0">
                      ...
                      <Badge variant={pruebas.psicologica === 'aprobado' ? 'default' : pruebas.psicologica === 'no aprobado' ? 'destructive' : 'secondary'}>
                        {pruebas.psicologica}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="relative flex items-start gap-4 pl-10">
                    ...
                    <div className="flex-1 space-y-3 min-w-0">
                      ...
                      <Badge variant={pruebaTecnica === 'aprobado' ? 'default' : pruebaTecnica === 'no aprobado' ? 'destructive' : 'secondary'}>
                        {pruebaTecnica}
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="relative flex items-start gap-4 pl-10">
                    ...
                    <div className="flex-1 space-y-3 min-w-0">
                      ...
                      <Badge variant={pruebas.medica === 'aprobado' ? 'default' : pruebas.medica === 'no aprobado' ? 'destructive' : 'secondary'}>
                        {pruebas.medica}
                      </Badge>
                    </div>
                  </div>
